...
class TestFetcherLogging(unittest.TestCase):
    def test_base_fetcher_logs_start_and_success(self):
        ...
        self.assertIn("[SuccessFetcher] Fetching daily data for 600519", log_text)
        self.assertIn("[SuccessFetcher] 600519 fetched successfully:", log_text)
    ...
    def test_manager_logs_fallback_and_final_success(self):
        ...
        self.assertIn("[SourceAttempt 1/2] [FailureFetcher] fetching 601006...", log_text)
        self.assertIn("[SourceFailed 1/2] [FailureFetcher] 601006:", log_text)
        self.assertIn("[SourceSwitch] 601006: [FailureFetcher] -> [SuccessFetcher]", log_text)
        self.assertIn("[SourceDone] 601006 fetched successfully via [SuccessFetcher]:", log_text)
    ...
    def test_efinance_rejects_hk_daily_without_calling_eastmoney(self, mock_get_config):
        ...
        self.assertIn("does not support HK daily data", str(captured.exception))
    ...
    def test_efinance_logs_eastmoney_endpoint_on_remote_disconnect(self):
        ...
        log_text = "\n".join(captured.output)
        self.assertIn("Eastmoney history K-line API failed:", log_text)
        ...
        self.assertIn("[EfinanceFetcher] 601006 fetch failed:", log_text)
