...
_THINKING_TOOL_LABELS: Dict[str, str] = {
    ...
    "get_daily_history": "Candle data fetch",
    "analyze_trend": "Technical indicator analysis",
    "get_chip_distribution": "Chip distribution analysis",
    "search_stock_news": "News search",
    "search_comprehensive_intel": "Comprehensive intelligence search",
    "get_market_indices": "Market overview fetch",
    "get_sector_rankings": "Sector analysis",
    "get_analysis_context": "Historical analysis context",
    "get_stock_info": "Basic info fetch",
    "analyze_pattern": "Candlestick pattern recognition",
    ...
    for step in range(max_steps):
        ...
        if progress_callback:
            if not tool_calls_log:
                ...
                thinking_msg = f"'{label}' completed, continuing deeper analysis..."
        ...
        if response.tool_calls:
            ...
            if progress_callback:
                progress_callback(stream_event("generating", step=step + 1, message="Generating the final analysis..."))
