    ...
    def send_to_ntfy(
        ...
        *,
        ...
        if not server_url or not topic:
            logger.error("NTFY_URL must be a full endpoint including the topic path, e.g. https://ntfy.sh/my-topic")
            return False
        ...
        try:
            ...
            logger.error("Failed to send ntfy message: network request error")
