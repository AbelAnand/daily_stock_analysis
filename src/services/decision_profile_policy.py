        ...
        warnings.append(
            {
                ...
                "message": (
                    f"Original action {guardrail.raw_action} was adjusted by the risk guardrail to "
        ...
        warnings.append(
            {
                ...
                "message": "Reassessment result failed the persistence risk guardrail and was not saved as a decision signal.",
                "params": {
                    "raw_action": guardrail.raw_action,
                    "final_action": guardrail.final_action,
