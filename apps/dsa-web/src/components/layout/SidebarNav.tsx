...
import { Activity, BarChart3, Bell, BriefcaseBusiness, ChartCandlestick, Gauge, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'trading', labelKey: 'layout.nav.trading', to: '/trading', icon: ChartCandlestick },
